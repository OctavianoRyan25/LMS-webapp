    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
        <div class="ep-card ep-card-body flex items-center gap-4">
            <div class="w-12 h-12 rounded-xl bg-brand-50 dark:bg-brand-500/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-brand-500" viewBox="0 0 24 24" fill="none"
        ...
        <div class="ep-card ep-card-body flex items-center gap-4">
            <div class="w-12 h-12 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-emerald-500" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
                <p class="text-2xl font-bold text-slate-800 dark:text-white">{{ number_format($stats['active']) }}</p>
                ...
                <tbody>
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td class="ep-td">
                                @php
                                    $roleColors = ['admin' => 'purple', 'instructor' => 'blue', 'student' => 'gray'];
